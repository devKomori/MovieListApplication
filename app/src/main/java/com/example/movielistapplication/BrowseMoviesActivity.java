...
public class BrowseMoviesActivity extends AppCompatActivity {
    ...
    /**
     * Sends a request to the TMDB api to get popular movies and updates the adapter
     * with the response.
     */
    ...
    /**
     * Searches the TMDB api for movies based on the search query and page number.
     * The first page of results is set to the adapter, while the next pages are added to the adapter.
     * Any errors that may occur are logged
     */
    ...
    /**
     * Sets up the recycler view for the activity and listens for scroll events.
     * There is 20 movies per page and when the user scrolls to the end of the list,
     * the next page is fetched and methods are called to add more movies and update the adapter.
     */
